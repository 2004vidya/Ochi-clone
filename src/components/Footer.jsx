...
const Footer = () => {
    ...
    useEffect(() => {
      const handleResize = () => {
        setIsMobile(window.innerWidth < 768); // Mobile size check
      };
      ...
      {isMobile ? (
        ...
        >
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="flex flex-row md:flex-row gap-16 md:gap-40 mt-12">
              <div className="w-full md:w-1/2   /">
                <div className="dets font-['Neue_Montreal'] text-2xl  py-6">
                  S:
                  {["Instagram", "Behance", "Facebook", "Linkedin"].map(
                    (item, index) => (
                      <a href="#" className="underline block leading-[10vw] text-xl">
                        {item}
                      </a>
                    )
                  )}
                </div>
                <div className="dets font-['Neue_Montreal'] text-2xl py-20">
                  L:
                  {[
                    "202-1965 W 4th Ave",
                    "Vancouver, Canada",
              ...
              <div className="w-full md:w-1/2">
                <div className="dets font-['Neue_Montreal'] text-2xl py-6">
                  ...
                  {[
                    ...
                    <a href="#" className="underline block leading-[9.5vw] text-xl">
                      {item}
                    </a>
                  ))}
                </div>
        ...
        >
          <div className="font-extralight flex flex-col justify-between w-full md:w-1/2 mb-8 md:mb-0">
            <div className="heading">
              <h1 className="text-[20vw] sm:text-[10vw] uppercase leading-none -mb-6">
                Eye-
              </h1>
              <h1 className="text-[20vw] sm:text-[10vw] uppercase leading-none -mb-6">
                Opening
          ...
          <div className="w-full md:w-1/2">
            <h1 className="text-[12vw] sm:text-[9vw] uppercase leading-none -mb-6">
              Presentations
            </h1>
            <div className="flex flex-col md:flex-row gap-16 md:gap-40 mt-12">
              <div className="w-full md:w-1/2">
                <div className="dets font-['Neue_Montreal'] py-6">
                  S:
                  {["Instagram", "Behance", "Facebook", "Linkedin"].map(
                    (item, index) => (
                      <a href="#" className="underline block text-xl">
                        {item}
                      </a>
                    )
                  )}
...
// const Footer = () => {
//   return (
//     <div style={{ fontFamily: "f1" }} className="flex  w-full h-screen  p-30 ">
//       <div className="font-extralight flex flex-col justify-between h-full w-1/2">
//         <div className="heading">
...
//           </div>
//           <div className="w-1/2">
//           <div className='dets font-["Neue_Montreal"] py-6 '> M:
//                 {["Home","Services","Our Work","About Us","Insights","Contact Us"].map((item,index)=><a href='#' className=' underline block text-xl  '>{item}</a>)}
//             </div>
